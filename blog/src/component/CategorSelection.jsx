...
const CategorSelection = ({onSelectCategory,activeCategory}) => {
  ...
  return (
    <div className='px-4 mb- lg:space-x-16 flex  flex-wrap items-center  border-b-2 py-5 text-gray-900 font-semibold'>
    ...
    categories.map((category)=>(
      ...
      className={`mr-2 space-x-2 ${activeCategory==category?"active-button":""}`}  
